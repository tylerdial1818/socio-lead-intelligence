  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-zinc-900 font-heading flex items-center gap-2">
        ...
        <Link
          ...
          className="text-sm text-zinc-600 hover:text-zinc-900 flex items-center gap-1 transition-colors"
        >
          View all
