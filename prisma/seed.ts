...
async function main() {
  // Create user
  const seedPassword = process.env.SEED_PASSWORD || "changeme-set-SEED_PASSWORD-env";
  ...
  const includeKeywords = [
    ...
    { term: "impact measurement", tier: "HIGH" as const, category: "Methods" },
    { term: "outcome measurement", tier: "HIGH" as const, category: "Methods" },
    ...
    { term: "survey services", tier: "MEDIUM" as const, category: "Services" },
    { term: "focus group", tier: "MEDIUM" as const, category: "Methods" },
    { term: "stakeholder engagement", tier: "MEDIUM" as const, category: "Services" },
    { term: "community engagement", tier: "MEDIUM" as const, category: "Services" },
    ...
    { term: "performance management", tier: "MEDIUM" as const, category: "Services" },
    { term: "strategic planning", tier: "MEDIUM" as const, category: "Services" },
    { term: "capacity building", tier: "MEDIUM" as const, category: "Services" },
    { term: "data analysis", tier: "MEDIUM" as const, category: "Methods" },
    { term: "data collection", tier: "MEDIUM" as const, category: "Methods" },
    { term: "ethnographic research", tier: "MEDIUM" as const, category: "Methods" },
    { term: "natural language processing", tier: "MEDIUM" as const, category: "Methods" },
    { term: "machine learning", tier: "MEDIUM" as const, category: "Methods" },
    { term: "econometrics", tier: "MEDIUM" as const, category: "Methods" },
    { term: "mathematical modeling", tier: "MEDIUM" as const, category: "Methods" },
    { term: "research services", tier: "MEDIUM" as const, category: "Services" },
    { term: "research consultant", tier: "MEDIUM" as const, category: "Services" },
  ...
  console.log(`  - 1 user (tyler@socio-analytics.com)`);
